...
def parse_question_string(question_string):
    summary_questions = re.findall(r"Question \d+: (.*?) \(covering \d+ questions\)", question_string)
...
#     summarize_template = """
# We received a list of questions from our Q&A on The Future of AI, presented by Gary Marcus.
...
#     print(llm_output)
#     # llm_output_without_empty_lines = '\n'.join([line for line in llm_output.splitlines() if line.strip()])
#     # print(llm_output_without_empty_lines)
